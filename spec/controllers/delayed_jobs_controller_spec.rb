...
RSpec.describe DelayedJobsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all delayed_jobs as @delayed_jobs" do
      ...
      expect(assigns(:delayed_jobs)).to eq([delayed_job])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested delayed_job as @delayed_job" do
      ...
      expect(assigns(:delayed_job)).to eq(delayed_job)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new delayed_job as @delayed_job" do
      ...
      expect(assigns(:delayed_job)).to be_a_new(DelayedJob)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created delayed_job as @delayed_job" do
        post :create, {:delayed_job => valid_attributes}, valid_session
        expect(assigns(:delayed_job)).to be_a(DelayedJob)
        expect(assigns(:delayed_job)).to be_persisted
      end

      it "redirects to the created delayed_job" do
        post :create, {:delayed_job => valid_attributes}, valid_session
        expect(response).to redirect_to(DelayedJob.last)
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested delayed_job" do
        delayed_job = DelayedJob.create! valid_attributes
        put :update, {:id => delayed_job.to_param, :delayed_job => new_attributes}, valid_session
        delayed_job.reload
      ...
      it "redirects to the delayed_job" do
        delayed_job = DelayedJob.create! valid_attributes
        put :update, {:id => delayed_job.to_param, :delayed_job => valid_attributes}, valid_session
        expect(response).to redirect_to(delayed_job)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the delayed_job as @delayed_job" do
        delayed_job = DelayedJob.create! valid_attributes
        put :update, {:id => delayed_job.to_param, :delayed_job => invalid_attributes}, valid_session
        expect(assigns(:delayed_job)).to eq(delayed_job)
      end
